    ...
    , m_windowBorderWidth(0)
{
    ...
    initConnections();
    loadStyleSheet();
    setTitleIcon(":/style/MyTitleBarDialog/Resources/titleicon.png",QSize(40,40));
}
...
void MyTitleBar::initControl()
{
    ...
    mylayout->setContentsMargins(5, 0, 5, 0);
...
{
    QFile file(":/style/MyTitleBarDialog/Resources/MyTitle.css");
