...
//    connect(this, &QtWidgetBase::signalBtnClicked, this, [=](int id){
//        qDebug() << "signalBtnClicked: " << id;
//    });
}
...
//    painter.setFont(font);
    ...
    painter.drawPixmap(m_rectHome, QPixmap(QString(":/images/menu_icon%1.png")
...
void Calculator::mouseMoveEvent(QMouseEvent *event)
{
    ...
    if (m_bMoveWindow)
    {
        QPoint newPos = mapToParent(event->pos() - m_startMovePos);
        this->move(newPos);
        this->update();
    }
