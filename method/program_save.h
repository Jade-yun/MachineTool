...
extern const QString SUFFIX_REFER;                   //参考点文件后缀名
...
extern bool saveProgram(D_ProgramNameAndPathStruct pro_temp);
extern bool readProgram(D_ProgramNameAndPathStruct pro_temp);
extern bool readLableOrderName(D_ProgramNameAndPathStruct pro_temp);
extern bool readPreviewLableOrderName(D_ProgramNameAndPathStruct pro_temp);
extern int readPreviewProgram(D_ProgramNameAndPathStruct pro_temp,P_ProOrderStruct *m_ProOrder);
