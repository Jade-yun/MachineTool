...
//端口自定义
uint8_t* getInportFuncDefine(uint8_t* defaultV)
{
    uint8_t* arr=defaultV;
    for(int i=0;i<INPUT_TOTAL_NUM;i++)
    {
        // 添加
        arr[i]=getValue("InportFuncDefine",QString("V%1").arg(i),defaultV[i]);
    }
    return arr;
}

void setInportFuncDefine(uint8_t *value)
{
    for(int i=0;i<INPUT_TOTAL_NUM;i++)
    {
        setValue("InportFuncDefine",QString("V%1").arg(i),value[i]);
    }
}

uint8_t* getOutportFuncDefine(uint8_t* defaultV)
{
    uint8_t* arr=defaultV;
    for(int i=0;i<OUTPUT_TOTAL_NUM;i++)
    {
        arr[i]=getValue("OutportFuncDefine",QString("V%1").arg(i),defaultV[i]);
    }
    return arr;
}

void setOutportFuncDefine(uint8_t *value)
{
    for(int i=0;i<OUTPUT_TOTAL_NUM;i++)
    {
        setValue("OutportFuncDefine",QString("V%1").arg(i),value[i]);
    }
}
//预留关联
...
D_ClawSaveStruct* getClawSave(D_ClawSaveStruct* defaultV)
{
    ...
    for(int i=0;i<CLAW_SAVE_NUM;i++)
    {
        ...
        arr[i].clawKeepoutMinX1=getValue("ClawSave",QString("clawKeepoutMinX1_%1").arg(i),defaultV[i].clawKeepoutMinX1);
        arr[i].clawKeepoutMaxX1=getValue("ClawSave",QString("clawKeepoutMaxX1_%1").arg(i),defaultV[i].clawKeepoutMaxX1);
        arr[i].clawKeepoutHighZ1=getValue("ClawSave",QString("clawKeepoutHighZ1_%1").arg(i),defaultV[i].clawKeepoutHighZ1);
        arr[i].cKeepoutMinX1=getValue("ClawSave",QString("cKeepoutMinX1_%1").arg(i),defaultV[i].cKeepoutMinX1);
        arr[i].cKeepoutMaxX1=getValue("ClawSave",QString("cKeepoutMaxX1_%1").arg(i),defaultV[i].cKeepoutMaxX1);
        arr[i].cKeepoutHighZ1=getValue("ClawSave",QString("cKeepoutHighZ1_%1").arg(i),defaultV[i].cKeepoutHighZ1);
        arr[i].cKeepoutPosMinX1=getValue("ClawSave",QString("cKeepoutPosMinX1_%1").arg(i),defaultV[i].cKeepoutPosMinX1);
        arr[i].cKeepoutPosMaxX1=getValue("ClawSave",QString("cKeepoutPosMaxX1_%1").arg(i),defaultV[i].cKeepoutPosMaxX1);
        arr[i].cKeepoutNegMinX1=getValue("ClawSave",QString("cKeepoutNegMinX1_%1").arg(i),defaultV[i].cKeepoutNegMinX1);
        arr[i].cKeepoutNegMaxX1=getValue("ClawSave",QString("cKeepoutNegMaxX1_%1").arg(i),defaultV[i].cKeepoutNegMaxX1);
    }
...
void setClawSave(D_ClawSaveStruct* value)
{
    for(int i=0;i<CLAW_SAVE_NUM;i++)
    {
        ...
        setValue("ClawSave",QString("clawKeepoutMinX1_%1").arg(i),value[i].clawKeepoutMinX1);
        setValue("ClawSave",QString("clawKeepoutMaxX1_%1").arg(i),value[i].clawKeepoutMaxX1);
        setValue("ClawSave",QString("clawKeepoutHighZ1_%1").arg(i),value[i].clawKeepoutHighZ1);
        setValue("ClawSave",QString("cKeepoutMinX1_%1").arg(i),value[i].cKeepoutMinX1);
        setValue("ClawSave",QString("cKeepoutMaxX1_%1").arg(i),value[i].cKeepoutMaxX1);
        setValue("ClawSave",QString("cKeepoutHighZ1_%1").arg(i),value[i].cKeepoutHighZ1);
        setValue("ClawSave",QString("cKeepoutPosMinX1_%1").arg(i),value[i].cKeepoutPosMinX1);
        setValue("ClawSave",QString("cKeepoutPosMaxX1_%1").arg(i),value[i].cKeepoutPosMaxX1);
        setValue("ClawSave",QString("cKeepoutNegMinX1_%1").arg(i),value[i].cKeepoutNegMinX1);
        setValue("ClawSave",QString("cKeepoutNegMaxX1_%1").arg(i),value[i].cKeepoutNegMaxX1);
    }
}
//产品设置
...
/*****************命令相关参数保存*****************/
QString m_configCmdPath = "";
QString m_configPortSettingPath = "";
QStringList getIniValues(uint8_t type, QString node)
{
    ...
    for(int key : keyList)
    {
        valueList.append(settings.value(QString::number(key)).toString());
    }
    if(!node.isEmpty())
    {
        settings.beginGroup(node);
