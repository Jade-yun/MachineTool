    ...
    QListWidget(parent)
{
    ...
    /* 设置样式 */
    setStyleSheet("                                                                           \
                  QListWidget {font-size: 22px; outline: none; border:1px solid #00000000; color: black; }    \
                  QListWidget::Item {font-size: 22px; width: 200px; height: 40px; }                            \
