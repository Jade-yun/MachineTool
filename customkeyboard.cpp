...
//    textInput->setStyleSheet(qss);
    ...
    v->setContentsMargins(0,50,0,0);//设置布局上边距为50px
    this->setLayout(v);
}
...
//        QTableWidgetItem *tableItem = qobject_cast<QTableWidgetItem*>(editObj);
        QTextEdit* textEdit = qobject_cast<QTextEdit*>(editObj);
//        auto* plainTextEdit = qobject_cast<QPlainTextEdit*>(editObj);
...
//        else if (tableItem)
//        {
//            tableItem->setText(textInput->text());
//        }
        else if (textEdit)
        {
...
//        {
//            plainTextEdit->setPlainText(textInput->text());
//        }
        else if(label)
        {
